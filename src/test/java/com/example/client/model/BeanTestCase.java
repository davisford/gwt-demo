...
/**
 * Shamelessly grabbed from <A HREF="http://blog.coryfoy.com/2008/05/unit-testing-equals-and-hashcode-of-java-beans/">
 * http://blog.coryfoy.com/2008/05/unit-testing-equals-and-hashcode-of-java-beans/</A>
 * <p>
 * Provides static methods to assert equals / hash contract is met.
 */
	...
	public static void assertMeetsEqualsContract(Class<?> classUnderTest) {
		...
		try {
			...
			for (int i = 0; i < fields.length; i++) {
				...
				assertFalse(
						"After setting o2 with a different object than what is in o1, the two objects in the field "+field.getName()+" are equal. "
